...
public class RgbPanel extends AbstractColorPanel {
    ...
    @Override
    protected ConvertBridge getCurrentColor() {
        return new NormalConvertBridge(new Rgb(sldR.getValue(), sldG.getValue(), sldB.getValue()));
    }

    @Override
    protected void updateCurrentColor(ConvertBridge bridge) {
