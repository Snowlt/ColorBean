...
public class FormulaForm extends JFrame {
    ...
    public FormulaForm(Hsb hsb) {
        ...
        sldBrightness.addChangeListener(e -> {
            ...
            currentColor.setB(sld.getValue());
            updateDisplay();
        });
    }
    ...
    private void updateDisplay() {
        ...
        double[] hues = ColorFormula.GetFormula(currentColor.h(), currentType, null);
        ...
        for (int i = 0; i < resultBindings.length; i++) {
            ...
            rb.setVisible(true);
            rb.setColor(new Hsb(hues[i], currentColor.s(), currentColor.b()));
        }
    }
    ...
    static class FormulaResultBinding {
        ...
        public void setColor(Hsb hsb) {
            ...
            colorBindings[1].setColor(new Hsb(hsb.h(), hsb.s(), 100));
            colorBindings[2].setColor(new Hsb(hsb.h(), 100, 100));
        }
